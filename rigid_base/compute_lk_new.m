function Lk = compute_lk_new(nbp,zvec)

% Given a vector of unknowns "zvec" with "nbp" base pairs, compute Lk

% Coded by Matthew Scharf June 2017. Used the mathematical theory described in 
...
nframes = nbp+1; % Includes fictional end frame
